...
// Your code here
const multipliedNums = nums.map((n) => {
	return n * 2;
});
...
// Your code here
function adLib(noun = 'cat', adjective = 'white') {
...
//Optional chaining
//Can put a ? after an object property that may or may not exist, which will return undefined rather than null and prevent an error from happening
const adventurer = {
    name: 'Alice',
};
